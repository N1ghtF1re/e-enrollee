...
<html>
<head>
    <title>Ct Certificate - ${entity.certificateIdentifier}</title>
...
<div class="container">
    ...
    <div>
        ...
        <dl class="row mt-4 mb-4 pb-3">
            <dt class="col-sm-3">Ct Certificate Identifier</dt>
            <dd class="col-sm-9"><c:out value="${entity.certificateIdentifier}"/></dd>

            <dt class="col-sm-3">Ct Certificate Number</dt>
            <dd class="col-sm-9"><c:out value="${entity.certificateNumber}"/></dd>
            ...
            <dd class="col-sm-9"><c:out value="${entity.ctPoints}"/>/100</dd>

            <dt class="col-sm-3">Subject</dt>
            <dd class="col-sm-9"><c:out value="${entity.subject}"/></dd>

            <dt class="col-sm-3">Year</dt>
            <dd class="col-sm-9"><c:out value="${entity.year}"/></dd>
        </dl>
    </div>
</div>
</body>
