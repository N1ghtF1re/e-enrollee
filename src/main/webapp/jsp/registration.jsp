                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <input type="text" name="lastName" class="form-control" placeholder="<fmt:message key="placeholder.firstName" />" value=""/>
                        </div>
                        <div class="form-group">
                            <input type="text" name="firstName" class="form-control" placeholder="<fmt:message key="placeholder.lastName" />" value=""/>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <input type="text" name="middleName" class="form-control" placeholder="<fmt:message key="placeholder.middleName" />" value=""/>
                        </div>
                        <div class="form-group">
